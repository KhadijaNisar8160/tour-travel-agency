          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Explore all corners of The Pakistan Places with us
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-500 tracking-wide leading-8"
                >
                  Explore the diverse beauty of Pakistan, from the majestic
                  mountains of the north to the vibrant cities and historic
                  landmarks. Discover breathtaking landscapes, rich culture, and
                  unforgettable adventures across every corner of the country.
                  <br />
                </p>
